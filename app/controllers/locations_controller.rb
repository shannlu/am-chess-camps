class LocationsController < ApplicationController
  ...
  def index
    @active_locations = Location.all.active.alphabetical.paginate(:page => params[:active_locations]).per_page(10)
    @inactive_locations = Location.all.inactive.alphabetical.paginate(:page => params[:inactive_locations]).per_page(10)
  end
